    ...
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          ...
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  <h2 class="mb-6 text-sm font-semibold text-white uppercase dark:text-white">Informations</h2>
              ...
              <div>
                  <h2 class="mb-6 text-sm font-semibold text-white uppercase dark:text-white">Services Clients</h2>
                  <ul class="text-white dark:text-gray-400 font-medium">
                      <li class="mb-4">
                          <a href="#" class="hover:underline ">Contactez-nous</a>
                      </li>
                      <li class="mb-4">
                          <a href="#" class="hover:underline">Livraison & Retours</a>
                      </li>
                      <li class="mb-4">
                          <a href="#" class="hover:underline">Conditions de ventes</a>
                      </li>
                  </ul>
              </div>
          </div>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-white sm:text-center dark:text-gray-400">© 2023 <a href="#" class="hover:underline">WE FASHION</a>. All Rights Reserved.
          </span>
